...
//
// Model: Haiku 4.5 (user-selected after A/B comparison against Opus 4.7).
// Haiku returns more matches (~15-20 vs Opus's ~5 per search) — more
// candidates to browse, at the cost of some false-positives Opus would
// have filtered. Cost ~$0.03/search, latency ~5-10s, vs Opus $0.12-0.18
// and 20-40s. Conditional code in scoreJobsWithLLM strips the
// thinking/effort params Haiku doesn't support.
